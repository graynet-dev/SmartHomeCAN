...
#define PWM_WRITE              3   // устройство управляемое ШИМ сигналом, подключено к PWM выходу ардуино
#define PROCENT_WRITE          4   // устройство управляемое градацией от 0 до 100%, подключено к ардуино может быть по разному. 
